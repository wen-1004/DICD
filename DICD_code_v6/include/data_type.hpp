...
// Port
using phi_t    = sc_fixed<16,6>;
using gamma_t  = sc_fixed<16,6>;
using mag_t    = sc_fixed<16,6>;
using ang_t    = sc_fixed<13,3>;
using lambda_t = sc_fixed<16,6>;

// Internal
using ambm_t   = sc_fixed <12,2>;
using PI_t     = sc_ufixed<10,0>;
