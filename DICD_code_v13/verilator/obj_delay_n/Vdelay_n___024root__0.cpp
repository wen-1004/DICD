...
void Vdelay_n___024root___nba_sequent__TOP__0(Vdelay_n___024root* vlSelf) {
    ...
    if (vlSelfRef.rst) {
        ...
        vlSelfRef.r_d1_real = vlSelfRef.r_in_real;
        vlSelfRef.r_d1_imag = vlSelfRef.r_in_imag;
    }
    if (vlSelfRef.rst) {
...
void Vdelay_n___024root___eval_debug_assertions(Vdelay_n___024root* vlSelf) {
    ...
    if (VL_UNLIKELY(((vlSelfRef.r_in_real & 0x80U)))) {
        Verilated::overWidthError("r_in_real");
    }
    if (VL_UNLIKELY(((vlSelfRef.r_in_imag & 0x80U)))) {
        Verilated::overWidthError("r_in_imag");
    }
}
#endif  // VL_DEBUG
