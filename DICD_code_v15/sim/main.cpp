// main.cpp — drive DUT, sample at 5311 ns + 2560*k, compare per-output goldens
#include <systemc>
#include <deque>
#include <fstream>
#include <vector>
...
int sc_main(int argc, char* argv[]) {
    ...
    sc_signal<in_r_t>  r_in_real("r_in_real");
    sc_signal<in_r_t>  r_in_imag("r_in_imag");
    ...
    const int     PIPE_CYCLES = 12;    // same as above, for actual sim steps
...
//        // Print Q1.15 bit patterns exactly as in the input files
//        // (bre/bim already contain only 0/1 chars per line)
//        if (i < bre.size() && i < bim.size()) {
//            std::cout << sc_time_stamp()
//                      << " | r_in_real(Q1.15)=" << bre[i]
//                      << " | r_in_imag(Q1.15)=" << bim[i]
//                      << "\n";
//        }
        ...
        if (sample_cnt >= FIRST_SAMPLES &&
            ...
            due.push_back(sample_cnt + PIPE_CYCLES - 2);
        }
