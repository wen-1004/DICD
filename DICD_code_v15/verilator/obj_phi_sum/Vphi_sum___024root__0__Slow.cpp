...
VL_ATTR_COLD void Vphi_sum___024root___ctor_var_reset(Vphi_sum___024root* vlSelf) {
    ...
    vlSelf->phi_sum__DOT__phi_out_d1 = VL_SCOPED_RAND_RESET_I(14, __VscopeHash, 16541125660657960352ull);
    vlSelf->phi_sum__DOT__phi_out_d2 = VL_SCOPED_RAND_RESET_I(14, __VscopeHash, 13797261059038098806ull);
    vlSelf->phi_sum__DOT__phi_out_d3 = VL_SCOPED_RAND_RESET_I(14, __VscopeHash, 8859101396997928963ull);
