...
VL_ATTR_COLD void Vdelay_n___024root___ctor_var_reset(Vdelay_n___024root* vlSelf) {
    ...
    vlSelf->r_in_real = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 9127817291261897851ull);
    vlSelf->r_in_imag = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 3125532235121349261ull);
